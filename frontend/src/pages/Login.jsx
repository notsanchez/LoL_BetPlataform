  ...
  return (
    <div>
      <div className='flex justify-center tracking-wide'>
        <div className='flex flex-col justify-center my-10 mx-1 h-auto w-[25vw]'>
          <form onSubmit={handleLogin} method='POST' id='form' className='bg-secondaryblack rounded-xl p-6 m-auto my-1 w-[100%]'>
            {error !== '' ? (<div className='p-4 border-2 text-center rounded-2xl text-red-900 border-red-900' id='login-warning-block'>
            ...
            <input className='rounded-md mt-10 bg-primary py-2 px-4 w-[100%] cursor-pointer' type="submit" value="Login"></input>
