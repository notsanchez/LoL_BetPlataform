    ...
    <div className='flex flex-col'>
      <div className='w-screen h-24 bg-blackbg flex items-center justify-between text-white px-12 drop-shadow-lg'>
        ...
        <div className='flex gap-6'>
          <Link to="/register" className='mx-6 my-2 font-semibold text-lg'>Registrar</Link>
          <button className='bg-primary px-6 py-2 rounded-lg font-semibold text-lg' onClick={handleLogout}>Entrar</button>
        </div>
      </div>

      <div className='w-screen h-12 bg-secondaryblack border-b-4 border-blackbg flex justify-center gap-24 text-white font-semibold text-lg'>
        <Link to="/home">
