...
const CTA = () => {
  ...
  return (
    <div className='justify-center flex mt-12'>
        <div className='w-[1200px] h-40 bg-[url("https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Katarina_10.jpg")] bg-black bg-cover border-2 border-blackbg bg-top bg-opacity-80 rounded-lg justify-center px-12 flex flex-col'>
